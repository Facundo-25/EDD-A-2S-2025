...
interface
  procedure ShowCreateUserWindow
;

implementation

    uses
        gtk2, glib2, gdk2, login
    ;    
    ...
    procedure OnRegisterButtonClick(widget: PGtkWidget; data: gpointer); cdecl;
        begin
        writeln('Register button clicked.');
        end
    ;
    ...
    procedure ShowCreateUserWindow;
        ...
        gtk_table_attach_defaults(GTK_TABLE(grid), btnRegister, 0, 1, 6, 7);
        gtk_table_attach_defaults(GTK_TABLE(grid), btnCancel, 1, 2, 6, 7);
